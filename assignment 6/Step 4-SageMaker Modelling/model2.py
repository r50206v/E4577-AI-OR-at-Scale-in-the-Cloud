...
import model_cnn2 as sentiment_model_cnn
...
def main(args):
    ...
    cp2=keras.callbacks.CSVLogger('./model_LSTM.csv', separator=',', append=False)
    ...
    model.fit(
        ...
        validation_steps=validation_dataset[2]["num_batches"],callbacks=[cp,cp2])
    ...
    sentiment_model_cnn.save_model(model, os.path.join(args.model_output_dir, "model_LSTM.h5"))
